...
This is an example of using lua to write an event function. You can use this example for secondary development, just modify the code/main.lua file.

#### Deploy Function

```bash
sam@iZj6c895xh98:~ cd lua/event-demo/
sam@iZj6c895xh98:~/lua/event-demo  s deploy -y
...
```bash
sam@iZj6c895xh98:~/lua/event-demo $ s invoke -e "hello"
