...
```bash
sam@iZj6c895xh98:~/ cd f#/http-demo/
sam@iZj6c895xh98:~/f#/http-demo  make build
...
[2021-07-26T17:09:41.359] [INFO ] [FC-DEPLOY] - Generated auto custom domain: fsharphttpfunc.custom-demo.123456789.cn-hangzhou.fc.devsapp.net
[2021-07-26T17:09:41.359] [INFO ] [FC-DEPLOY] - Creating custom domain: fsharphttpfunc.custom-demo.123456789.cn-hangzhou.fc.devsapp.net
[2021-07-26T17:09:42.190] [INFO ] [FC-DOMAIN] - Creating custom domain: fsharphttpfunc.custom-demo.123456789.cn-hangzhou.fc.devsapp.net
...
fc-fsharp_demo-fc_fsharp:
  ...
  url:
    system_url: >-
      https://123456789.cn-hangzhou.fc.aliyuncs.com/2016-08-15/proxy/custom-demo/fsharpHttpFunc/
    custom_domain:
      - domain: >-
          http://fsharphttpfunc.custom-demo.123456789.cn-hangzhou.fc.devsapp.net
  triggers:
    - type: http
      name: http_t
```
...
```bash
sam@iZj6c895xh98:~/f#/http-demo $ curl http://fsharphttpfunc.custom-demo.123456789.cn-hangzhou.fc.devsapp.net
["hello","world"]
sam@iZj6c895xh98:~/f#/http-demo $ curl http://fsharphttpfunc.custom-demo.123456789.cn-hangzhou.fc.devsapp.net/weatherforecast
