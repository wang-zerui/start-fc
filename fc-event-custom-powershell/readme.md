...
- 初始化一个模版项目：`s init devsapp/custom-powershell-http-python3`
- 进入项目后部署项目：`cd custom-powershell && s deploy`

## 阿里云在线体验

[点击此处可以在线体验通过Serverless Devs部署FC案例到阿里云函数计算](https://api.aliyun.com/new#/tutorial?action=git_open&git_repo=https://github.com/devsapp/devsapp-cloudshell-example.git&tutorial=tutorial/custom-powershell.md)
